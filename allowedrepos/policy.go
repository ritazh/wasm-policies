...
func eval() {
	...
	for _, container := range pod.Spec.Containers {
		// TODO: need to properly parse the parameters
		decision = strings.Contains(container.Image, parameters)
	}

	fmt.Println(decision)
	log(fmt.Sprint("wasm guest objectToTest >> ", pod, ", parameters >> ", string(parameters)))
}
